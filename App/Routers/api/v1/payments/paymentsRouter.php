...
$router->create('POST', '/api/v1/payments/sales/{venda_uuid}', [$pagamentoController, 'processSalePayment'], $auth);
$router->create('POST', '/api/v1/payments/{uuid}/cancel', [$pagamentoController, 'cancelPayment'], $auth);
